...
def process_data(
    ...
    for the categorical features and a label
    binarizer for the labels. This can be used
    ...
    OneHotEncoder
        Trained sklearn OneHotEncoder, only used
        if training=False.
    lb : sklearn.preprocessing._label.LabelBinarizer
        Trained sklearn LabelBinarizer, only used
        if training=False.
